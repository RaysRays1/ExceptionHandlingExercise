...
namespace ExceptionHandlingExercise
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var arr = new string[] { "23", "24", "18", "3", "6", "17", "B", "A", "R" };
            ...
            foreach (var strNumber in arr)
            {
                try
                {
                    int character  = int.Parse(strNumber.ToString());
                ...
                {
                    Console.WriteLine($"Unable to Parse {strNumber}"); //character will be the name of each item in your collection
